...
public class Chessboard : MonoBehaviour
{
    ...
    [SerializeField] private float yOffset = 0.00001f;
   ...
   private void Update()
   {
        ...
        if (Physics.Raycast(ray, out info, 300, LayerMask.GetMask("Tile", "Hover", "Highlight")))
        {
            ...
            //if we were already hovering a tile, change previus
    ...
    private void PositionSinglePiece(int x, int y, bool force = false){
        ...
        chessPieces[x, y].SetScale(new Vector3(1.4f, 1.4f, 1.4f), true);
    }
            ...
            if (myPawn.currentX == enemyPawn.currentX)
            {
                if (enemyPawn.team == 0)
                {
                    ...
                    enemyPawn.SetPosition(
                        new Vector3(8.8f * tileSize, deathHeight, -1 * tileSize)
                        - bounds
                ...
                else
                {
                    ...
                    enemyPawn.SetScale((Vector3.one) * deathSize);
                    enemyPawn.SetPosition(
                    new Vector3(-1.8f * tileSize, deathHeight, 8 * tileSize)
                    - bounds
                    + new Vector3(tileSize / 2, 0, tileSize / 2)
    ...
    private void SimulateMoveForSinglePiece(ChessPiece cp, ref List<Vector2Int> moves, ChessPiece targetKing){
        ...
        for (int i = 0; i < moves.Count; i++)
        {
            ...
            if (ContainsValidMoves(ref simMoves, kingPositionThisSim))
            {
    ...
    private bool CheckForCheckmate(){
        ...
        {
            //King is under attack, can we move something something to help him?
